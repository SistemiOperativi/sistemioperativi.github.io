...
3. Terminare il processo corrente utilizzanto :posix:`exit <exit>`.

Il main thread esegue la stampa di riga e successivamente invoca la fork per creare un processo child.
